function model = createModelHL(model_fun, T_s, numScenarios, implicitPrediction, controller)
...
%     end
    ...
    [ode_k, n_x, n_u, n_d,eta] = model_fun(T_s(1),1);
    ...
    model.case=binvar(2,length(T_s),'full');
    model.n_x = n_x;
    model.n_u = n_u;
    model.n_d = n_d;
   ...
   % model.odes_alt = {};
    ...
    for k=1:N_pred
        ...
        %model.odes_alt{end+1}=ode_k_alt;
